...
let superstateRegions = viewbox.append("g").attr("id", "superstates");
superstateRegions.append("g").attr("id", "superstatesBody");
superstateRegions.append("g").attr("id", "superstateLabels");
